...
class Metrics:
    def __init__(self, currency):
        ...
        self.mid_stoploss_metric = Gauge('trade_bot_mid_stoploss', 'Mid stoploss value', ['currency'], registry=registry)
    ...
    def update_metrics_on_buy(self, symbol, current_price, stoploss, stopgain, mid_stoploss, potential_loss, potential_gain):
        ...
        self.mid_stoploss_metric.labels(symbol).set(mid_stoploss)
